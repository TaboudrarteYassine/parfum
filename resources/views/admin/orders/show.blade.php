    ...
    <div class="md:col-span-2 space-y-6">
        ...
        <div class="bg-card rounded-lg border border-orange-900 shadow-sm p-6">
            ...
            <p class="text-sm text-gray-400 mb-4">
                ...
                Enregistrez le retour ici pour <strong class="text-white">restaurer le stock automatiquement</strong> et annuler la commande.
            </p>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-card rounded-lg border border-border shadow-sm p-6">
            ...
            <form action="{{ route('admin.orders.status', $order) }}" method="POST">
                ...
                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 rounded">Mettre à jour</button>
            </form>
        </div>
    </div>
</div>
